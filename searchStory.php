            ...
            <div class="side_container">
                <table class="diary">
                    ...
                    <?php 
                        ...
                        $userID = $_REQUEST['diaryID'];
                        $sqlSearchDiary = "SELECT * FROM story 
                        WHERE story_id LIKE '%{$name}%' AND diary_id = {$diaryID} 
                        OR story_date LIKE '%{$name}%' AND diary_id = {$diaryID} 
                        OR story_message LIKE '%{$name}%' AND diary_id = {$diaryID}";
                    ...
                    ?> 
                    <tr>   
                        <td><?php echo $diaryResult['story_id']?></td>
                        <td><?php echo $diaryResult['story_date']?></td>
                        <td><?php echo $diaryResult['story_message']?></td>
                        <td>
                        <div class="group_right">
                        <form  method="POST" action="deleteStory.php?storyID=<?php echo $diaryResult['story_id']?>">
                        <input type="hidden" name="userID" value="<?php echo $userID?>">
                        <input type="hidden" name="diaryID" value="<?php echo $diaryID?>">
                        <button type="submit" class="btn_right_delete">
                        <i class='bx bxs-trash' ></i></button>
                        </form>
                        <form method="POST" action="view_story.php?storyID=<?php echo $diaryResult['diary_id']?>">
